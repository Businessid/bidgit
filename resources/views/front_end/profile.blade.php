                ...
                <div class="secondary-nav">
                  <ul class="">
                    ...
                    <ul class="d-inline-block secondary-nav2">
                      ...
                      <li><a href="" class="last-child"><!-- <img src="images/icon/cat/tender1.png"> --><span>Job</span></a></li>
                    </ul>
                  </ul>
                </div>
              </div>
                ...
                <table class="wdt-100-prc" style="height: 100%;">
                  <tr>
                    ...
                    <td class="align-middle pd-lft-25 text-center"><div class="row scrl-flwrs">
                      ...
                      <a href="#" class="prf-flw-btn on-scrl"><span><i class="fa fa-user-plus" aria-hidden="true"></i></span>follow</a></td>
                  </tr>
                </table>
              </div>
...
" /> </a>
                ...
                <div class="tb-tp-1 mrg-t-10">
                  <ul class="nav nav-pills nav-fill">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="profileimages.php"> <span class="nv-icn-1"><i class="fa fa-gavel" aria-hidden="true"></i></span> Tenders </a> </li>
                    <li class="nav-item"> <a class="nav-link" href="profilevideo.php"> <span class="nv-icn-1"><i class="fa fa-address-card" aria-hidden="true"></i></span> Jobs </a> </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="bx-lft-prf">
              <div class="tp-bx-rp-5 bg-fff lght-bx-shdw mrg-b-10 ">
                ...
                <div class="flex-row-prf font-fmly-ar bx-shdw-btm">
                  ...
                  <div class="flex-row-prf-cl  text-center">
                    <div class="prf-txt-1">Following</div>
                    <div class="prf-txt-2">30</div>
                  </div>
                </div>
                <div class="text-center pd-20-all"> <a href="#" class="prf-flw-btn"><span><i class="fa fa-user-plus" aria-hidden="true"></i></span>follow</a> </div>
              </div>
              ...
              <div class="rght-stckd" data-sticky_column>
                <div class="ad-bx-tp-1 font-fmly-ar bg-fff lght-bx-shdw mrg-b-10 ">
                  <div class="lft-txt-tp-1 clearfix"> <span class="lft-txt-tp-1-m"></span> Products <span class="float-left lft-txt-tp-1-l cart-img-thmp"><i class="fa fa-shopping-cart" aria-hidden="true"></i></span> <span class="float-right lft-txt-tp-1-r"><i class="fa fa-plus" aria-hidden="true"></i></span> </div>
                  <div class="grd-bx-tp-fl-1">
                    <div class="prodct-bx-tp-1">
                      <table>
                        <tr>
                          <td class="align-middle wdt-80-px"><img class="lazy img-fluid prdct-img-1" src="{{ URL::asset('front_end/images/f1.jpg') }}" alt="" title=""></td>
                      ...
                      <table>
                        <tr>
                          <td><div class="flw-txt-1">Nike model5250</div>
                            <div class="flw-txt-2">Casual-f-m-c</div>
                            <a href="#" class="prf-flw-btn mrg-tp-5">View on Store</a></td>
                          <td class="align-middle wdt-80-px"><img class="lazy img-fluid prdct-img-1" src="{{ URL::asset('front_end/images/f2.jpg') }}" alt="" title=""></td>
                        </tr>
                      </table>
                    </div>
                    <div class="prodct-bx-tp-1">
                      <table>
                        <tr>
                          <td class="align-middle wdt-80-px"><img class="lazy img-fluid prdct-img-1" src="{{ URL::asset('front_end/images/f3.jpg') }}" alt="" title=""></td>
                          <td><div class="flw-txt-1">Nike model5250</div>
                            <div class="flw-txt-2">Casual-f-m-c</div>
                            <a href="#" class="prf-flw-btn mrg-tp-5">View on Store</a></td>
                        </tr>
            ...
            <div class="prf-txt-bx-3 lght-bx-shdw">
              <div class="tb-tp-1">
                <ul class="nav nav-pills nav-fill">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="#"> <span class="nv-icn-1"><i class="fa fa-gavel" aria-hidden="true"></i></span> Tenders </a> </li>
                  <li class="nav-item"> <a class="nav-link" href="#"> <span class="nv-icn-1"><i class="fa fa-address-card" aria-hidden="true"></i></span> Jobs </a> </li>
                </ul>
              </div>
            </div>
              ...
              <div class="flex-bx-2">
                    ...
                    <div class="bx-tp-post-bx-1-cnt">
                      <div class="tab-bx-tp-2 bg-fff mrg-l-r-re">
                        <ul class="nav nav-pills nav-fill bg-fff brd-btm-e4e4e4" id="pills-tab" role="tablist">
                          ...
                          <li class="nav-item">
                            <a class="nav-link"  data-toggle="pill" href="#" role="tab" aria-controls="pills-addtenders" aria-selected="false"><span class="mrg-r-5"><i class="fa fa-gavel" aria-hidden="true"></i></span>Add Tenders</a>
                          </li>
                          <li class="nav-item">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                          <div class="tab-pane fade show active" id="pills-compose" role="tabpanel" aria-labelledby="pills-compose-tab">
                            ...
                            <div class="bx-tp-img-vdo-upl">
                              {{ Form::open(array('url' => 'profile/fileupload', 'enctype' => 'multipart/form-data','class'=>'dropzone')) }}
                ...
                <div class="prf-rght-bar">
                  ...
                  <div class="ad-bx-tp-1 bx-shdw-btm font-fmly-ar mrg-b-10 bg-fff">
                    <div class="prf-txt-5 font-fmly-ar clearfix"> Who To Follow <a href="" class="float-right lnk-tp-mr-1">More</a> </div>
                  ...
                  <div class="ppl-may-bx ad-bx-tp-1 bx-shdw-btm font-fmly-ar mrg-b-10 bg-fff">
                    <div class="prf-txt-5 font-fmly-ar clearfix"> People you may know <a href="" class="float-right lnk-tp-mr-1">More</a> </div>
                    <div class="wht-fl-bx-1">
                      <table>
                        <tr>
                  ...
                  <div class="rght-stckd" data-sticky_column>
                    <div id="cht-bx-cnt" class="ad-bx-tp-1 bx-shdw-btm font-fmly-ar mrg-b-10 bg-fff bx-tp-chat pos-rel">
