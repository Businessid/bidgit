...
@endif
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                <label for="p_o_box" class="field-label">P.O.Box:</label>
                                <input type="text" class="form-control field-control" name="p_o_box" id="p_o_box" value="" placeholder="" data-fv-field="p_o_box">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control field-control" name="latitude" id="latitude" value="" placeholder="" data-fv-field="latitude">
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                                <label for="longitude" class="field-label">Longitude:</label>
                                <input type="text" class="form-control field-control" name="longitude" id="longitude" value="" placeholder="" data-fv-field="longitude">
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control field-control" name="license_no" id="license_no" value="" placeholder="" data-fv-field="license_no">
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                                <label for="registration_no" class="field-label">Registration No:</label>
                                <input type="text" class="form-control field-control" name="registration_no" id="registration_no" value="" placeholder="" data-fv-field="registration_no">
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                            ...
                            <div class="col-md-12 mx-auto">
                              <div class="row">
                                ...
                                <div class="col-md-6 pl-0">
                                  <div class="full-wrap full-register-box border-left-0 second"> <a href="" class="btn mx-auto sw-btn-next complete-reg" id="goto-next3">Go to, &nbsp;<span>Next Step</span></a>
