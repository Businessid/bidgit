...
<fieldset>
  ...
  <div class="lg-reg reg-form">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="form-group">
          <label for="category" class="field-label">Activity:</label>
...
@endif                        
  ...
  <div class="col-md-3">
  <div class="form-group">
  <label for="license_no" class="field-label">
  ...
  <div class="col-md-3">
  <div class="form-group">
  <label for="registration_no" class="field-label">
  ...
  <div class="col-md-3">
  <div class="form-group">
  <label for="inputGroupFile01" class="field-label">
