        ...
        <div class="col-md-12 order-box mt-2">
          <div id="smartwizard1" class="mt-2">
              <ul>
                 ...
                 <li class="text-center"><a href="#step-4"><i class="fa fa-sitemap" aria-hidden="true"></i><br /><small>Branches</small></a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                              <div class="col-md-6 pr-0">
                                ...
                                <div class="or-box">
                                <!-- <i class="fa fa-hand-o-right" aria-hidden="true"></i> -->OR
                              </div>
                            ...
                            <div class="col-md-6 pl-0">
                                <div class="full-wrap full-register-box border-left-0 second">
                                   <a href="" class="btn mx-auto complete-reg">Go to, &nbsp;<span>Next Step</span></a>
                                    ...
                                    You can add Property, New Car , Used Car, Services, Wholesale ...
                                  </li>
                                  </ul>
                                </div>
                            </div>
                  ...
                  <div id="step-2" class="mt-2">
                      <div class="lg-reg reg-form">
                       ...
                       <div class="full-wrap super-user-wrap">     
                           <div class="full-wrap">
                            <img src="{{ URL::asset('front_end/images/icon/super.png') }}" class="d-inline-block">
