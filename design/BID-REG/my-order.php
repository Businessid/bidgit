...
<div class="canvas">
  ...
  <div class="full-wrap bg-store pb-4">     
    <div class="container"> 
      <div class="col-md-8 mx-auto mt-5" style="min-height: 300px;">   
      <div class="row">
        <div class="col-md-6 p-0">
          <div class="full-wrap my-order-cat">
            <ul>
              <li class="cat-item my-basket">
                <a href="">
                  <img src="images/icon/basket.png">
                  <div class="title">My Basket</div>
                </a>
              </li>
              <li class="cat-item my-bending">
                <a href="">
                  <img src="images/icon/bending.png">
                  <div class="title">Bending Order</div>
                </a>
              </li>
               <li class="cat-item my-recieved">
                <a href="">
                  <img src="images/icon/recieved.png">
                  <div class="title">Recieved Order</div>
                </a>
              </li>
               <li class="cat-item my-cancel">
                <a href="">
          ...
          <div class="col-md-6 my-order-cat p-0">
            <ul>
              <li class="cat-item my-confirm">
                <a href="">
                  <img src="images/icon/confirm.png">
                  <div class="title">Confirmed Order</div>
                </a>
              </li>
               <li class="cat-item my-track">
                <a href="">
                  <img src="images/icon/track.png">
                  <div class="title">Tracking Order</div>
                </a>
              </li>
               <li class="cat-item my-return">
                <a href="">
                  <img src="images/icon/order-t.png">
                  <div class="title">Order Returns</div>
                </a>
              </li>
              <li class="cat-item my-history">
                <a href="">
