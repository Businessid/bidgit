  	...
  	<main id="main-content" class="back-ground-ap vert-algn-mdl">
  		<div class="container hero-box">
  			<div class="hero-box-1">
  				<div class="hero-box-12-cnt">
  						<div class="nav-bx-nws">
  								<ul class="navbar-nav">
								    <li class="nav-item">
  						...
  						<div class="rc-cmp-bx-tp-1-cnt">
	  						<div class="bx-tp-nws-tp-sld">
	  							<div id="news-crsl-1" class="owl-carousel owl-theme product-slider-tp-1">
	  								<div class="item">
	  									<div class="bx-tp-nws-tp-sld-cnt">
	  										<table>
	  											<tr>
	  												<td class="align-middle wdt-30-pr">
	  													<img class="lazy img-thmb-1" data-src="images/shake1.jpg" alt="" title="">
	  												</td>
	  												<td class="align-middle pd-lft-10 pd-rgt-10">
	  													<div class="txt-desc-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
	  								...
	  								<div class="item">
	  									<div class="bx-tp-nws-tp-sld-cnt">
	  										<table>
	  											<tr>
	  												<td class="align-middle wdt-30-pr">
	  													<img class="lazy img-thmb-1" data-src="images/shake2.jpg" alt="" title="">
	  												</td>
	  												<td class="align-middle pd-lft-10 pd-rgt-10">
	  													<div class="txt-desc-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
	  													tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</div>
	  								...
	  								<div class="item">
	  									<div class="bx-tp-nws-tp-sld-cnt">
	  										<table>
	  											<tr>
	  												<td class="align-middle wdt-30-pr">
	  													<img class="lazy img-thmb-1" data-src="images/shake3.jpg" alt="" title="">
	  												</td>
	  												<td class="align-middle pd-lft-10 pd-rgt-10">
	  													<div class="txt-desc-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
	  													tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</div>
