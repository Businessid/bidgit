  ...
  <?php include 'modules/header2.php';?>
            ...
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 bhoechie-tab">
                ...
                <div class="bhoechie-tab-content">
                 ...
                 <ul class="nav nav-tabs switch-address-tab-wrap" id="myTab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="home-tab" data-toggle="tab" href="#del-add" role="tab" aria-controls="home" aria-selected="true">
                      <i class="fa fa-address-card-o" aria-hidden="true"></i>Personal Address</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">
                      <i class="fa fa-truck" aria-hidden="true"></i>Delivery Address</a>
                    </li>
                </ul>
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="del-add" role="tabpanel" aria-labelledby="home-tab">
                       <div class="row mt-3">
                      <div class="col-md-12">
   ...
   <div class="full-wrap" id="edit-cv-form">
                ...
                <div class="full-wrap cv-sec mt-1">
                 ...
                 <div class="full-wrap cv-sec mt-1">
                      <div class="cv-sec-head">
                        <i class="fa fa-certificate" aria-hidden="true"></i>Certification 
                      </div>
                      <div class="row  mt-1">                        
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="field" class="field-label">Title:</label>
                          <input class="form-control field-control" type="text" id="field" name="field[]" placeholder="" value="">
                        </div>
                      </div>
                       <div class="col-md-4">
                        <div class="form-group"><label class="field-label">From:</label>
                          <div class="form-group">
                            <input class="form-control field-control" type="month" id="month_1" name="from[]" placeholder="From">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group"><label class="field-label">To:</label>
                          <div class="form-group">
                            <input class="form-control field-control" type="month" id="month_1" name="from[]" placeholder="From">
                          </div>
                        </div>
                      ...
                      <div class="row  mt-1">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="field" class="field-label">Description:</label>
                            <textarea class="form-control" name="job_summary" id="job_summary" placeholder=""></textarea>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                              <label for="id_image" class="field-label">Upload File:</label><br>
                     ...
                     <div class="content-wrap reg-form">
                      <div class="row">
                        <div class="col-md-12 mx-auto">
                          <div class="form-group"><label class="field-label">Description:</label><textarea class="form-control field-control" type="text" name="description[]" placeholder="" rows="6" style="margin-top: 5px !important;"></textarea>
                        </div>
                      </div>
