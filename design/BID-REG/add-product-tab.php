...
<div class="canvas">
  ...
  <div class="full-wrap bg-store pb-4" style="min-height: 470px;">     
    <div class="container"> 
      ...
      <ul id="menu" class="nav-cat-tabs no-bullet" >
          <li><a href="#" class="nav-link active"><img src="images/icon/new.png"><i>New</i></a></li>
          <li><a href="add-product-tab-used.php" class="nav-link"><img src="images/icon/used-r.png"><i>Used</i></a></li> 
          <li>
      ...
      <div class="row">
        <div class="col-md-12" id="pages">
          <div class="page" id="tab1" data-page="information">
