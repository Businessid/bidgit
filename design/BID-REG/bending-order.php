        ...
        <div class="col-md-10 order-box-wrap1  mx-auto p-0">
          <div class="full-wrap order-bread-crump pb-0">
            <ul>
              ...
              <li class="active"><a href="">Bending Order</a></li>  
            </ul>
          </div>
            ...
            <div class="_3xiuDJ">
              <div class="row">
                ...
                <div class="col-md-4 order-item-detail">
                  <a href="">Timer Watch001 Fierce And Fabulous Watch</a>
                  ...
                  <span  class="detail-item">Seller: &nbsp; <a href="" class="seller-name">ABC Traders</a></span>
                </div>
                <div class="col-md-3 text-center mx-auto">
                <div class="cancel-order">Waiting For Seller Confirmation</div>
                </div>
                <div class="col-md-3 order-item-detail ml-auto text-right">
                 ...
                 <div class="full-wrap">
                  <div class="seller-action mt-3">
                    <a href="javascript:void(0)" class="decline" id="order-decline"><i class="fa fa-times-circle" aria-hidden="true"></i>Cancel
                    </a>
                  </div>
                </div>
          </div>
