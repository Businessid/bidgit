  ...
  <div class="full-wrap bg-store pb-4" style="min-height: 470px;">     
    <div class="container"> 
      ...
      <ul id="menu" class="nav-cat-tabs no-bullet" >
          <li><a href="add-product-tab.php" class="nav-link"><img src="images/icon/new.png"><i>New</i></a></li>
          <li><a href="add-product-tab-used.php" class="nav-link active"><img src="images/icon/used-r.png"><i>Used</i></a></li> 
          <li>
                ...
                <div class="card-header" id="t-area">
                  <h5 class="mb-0">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#t-area-collapse" aria-expanded="false" aria-controls="t-area">
                     <span class="badge badge-light">6</span>Contact Detail
                    </button>
                  </h5>
                </div>
                  ...
                  <div class="card-body">
                     <div class="content-wrap reg-form">
                      <div class="row">
                         <div class="col-md-4">
                          <div class="form-group">
                          <label for="first_name" class="field-label">Name:</label>
                          <input type="text" class="form-control field-control" name="first_name" id="first_name" value="" placeholder="" data-fv-field="first_name">
                        </div>
                       </div>
