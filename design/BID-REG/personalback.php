  	...
  	<main id="main-content" class="back-ground-ap vert-algn-mdl">
  		...
  		<div class="bx-tp-src-rslt-cnt-1">
  			...
  			<div class="bx-tp-sr-rslt">
  				...
  				<div class="row">
  					<div class="col-md-8">
  						<div class="rc-cmp-bx-tp-1 ppl-may-knw">
		  					<div class="rc-cmp-bx-tp-1-cnt">
		  						<div class="txt-tp-31">People You May Know..</div>
		  						<div class="rc-usr-bx">
		  							<div class="row">
		  								<div class="col-md-2">
		  										...
		  										<a href="#">
			  										<div class="wrp-lg-tp-1">
			  											<table>
			  												<tr>
			  													<td class="align-middle">
			  														<img class="lazy" data-src="images/demo1.jpeg" alt="#" title="#">
			  													</td>
			  												</tr>
			  											</table>
			  										</div>
			  										<div class="txt-tp-32">Ijas Np</div>
		  										...
		  										<a href="#">
			  										<div class="wrp-lg-tp-1">
			  											<table>
			  												<tr>
			  													<td class="align-middle">
			  														<img class="lazy" data-src="images/demo2.jpeg" alt="#" title="#">
			  													</td>
			  												</tr>
			  											</table>
			  										</div>
		  										...
		  										<a href="#">
			  										<div class="wrp-lg-tp-1">
			  											<table>
			  												<tr>
			  													<td class="align-middle">
			  														<img class="lazy" data-src="images/demo3.jpeg" alt="#" title="#">
			  													</td>
			  												</tr>
			  											</table>
			  										</div>
		  										...
		  										<a href="#">
			  										<div class="wrp-lg-tp-1">
			  											<table>
			  												<tr>
			  													<td class="align-middle">
			  														<img class="lazy" data-src="images/demo4.jpeg" alt="#" title="#">
			  													</td>
			  												</tr>
			  											</table>
			  										</div>
				  					...
				  					<div class="col-md-6">
				  						<div class="grd-tp-5">
							  				<div class="rslt-box-1">
								  				<table class="prs-pht-vert">
								  					<tr>
								  						<td class="align-middle">
											  				<a href="#" class="rslt-box-1-lnk-1">
											  					<span class="user-img-icn">
								  									<img class="lazy" data-src="images/demo1.jpeg" alt="#" title="#">
								  								</span>
								  							</a>
								  						</td>
								  						...
								  						<td class="align-middle">
								  							<span class="verified-btn-1 clearfix">
							  									<div class="tick">
																    <div class="verifiedImg">
																        <img src="images/verification.png" alt="#" title="#">
																    </div>
																</div>
																verified
							  								</span>
					  							...
					  							<div class="bx-tp-lnk-bx-4">
					  								<ul class="nav">	
														<li class="nav-item">
															<a href="#" class="nav-link active"><span><i class="fa fa-heart"></i></span>Following</a>
														</li>
														<li class="nav-item">
				  						...
				  						<div class="grd-tp-5">
							  				<div class="rslt-box-1">
					  							...
					  							<div class="bx-tp-lnk-bx-4">
					  								<ul class="nav">	
														<li class="nav-item">
															<a href="#" class="nav-link"><span><i class="fa fa-heart"></i></span>Follow</a>
														</li>
														<li class="nav-item">
															<a class="nav-link" href="#"><span><i class="fa fa-anchor"></i></span>Add to Enquiry</a>
														</li>
