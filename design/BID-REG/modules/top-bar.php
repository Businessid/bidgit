<div id="overlapblackbg"></div>
    <div class="wsmobileheader clearfix"> <a id="wsnavtoggle" class="animated-arrow"><span></span></a> <a class="smallogo"><img src="images/sml-logo.png"  alt="" /></a> <a class="callusicon" href="tel:123456789"><span class="fa fa-phone"></span></a> </div>
    <div class="headtoppart clearfix">
      <div class="headerwp">
        <div class="headertopleft">
          <div class="address clearfix"><span><i class="fa fa-map-marker" aria-hidden="true"></i> 3982 Nasco Building, Dubai, Uae 12345 </span> <a href="#"><i class="fa fa-phone" aria-hidden="true"></i> 123-456-7890</a></div>
        </div>
    ...
    <div class="headerfull yellow-grdt">
      <!--Main Menu HTML Code-->
      <div class="wsmain">
        <div class="smllogo"><a href="#"><img src="images/sml-logo.png" alt=""/></a></div>
        <nav class="wsmenu clearfix">
          <ul class="mobile-sub wsmenu-list">
            <li><a href="#" class="navtext"><span>Search in</span> <span>Store</span></a>
            ...
            <li><a href="#" class="navtext"><span>Search in</span> <span>Jobs</span></a>
              <div class="wsshoptabing wtsbrandmenu clearfix">
                <div class="wsshoptabingwp clearfix">
                  <ul class="wstabitem02 clearfix">
                    <li class="wsshoplink-active"><a href="#"><i class="fa fa-slideshare brandcolor01" aria-hidden="true"></i>Accounting</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Latest Jobs</li>
                            ...
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Mostviewed Jobs</li>
                            ...
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Trending jobs</li>
                            ...
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">More Jobs</li>
                    ...
                    <li><a href="#"><i class="fa fa-slideshare brandcolor01" aria-hidden="true"></i> Airlines &amp; Aviation</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Latest Jobs</li>
                                <li><a href="#">List Products 011 </a> <span class="wstmenutag redtag">Popular</span></li>
                                <li><a href="#">List Products 012</a></li>
                                <li><a href="#">List Products 011113</a></li>
                                <li><a href="#">List Products 01114</a> </li>
                                <li><a href="#">List Products 0115</a> </li>
                                <li><a href="#">List Products 016</a></li>
                              </ul>
                            </div>
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Mostviewed Jobs</li>
                                <li><a href="#">List Products 0222227 </a></li>
                                <li><a href="#">List Products 0222228</a></li>
                                <li><a href="#">List Products 022229</a></li>
                                <li><a href="#">List Products 12220</a> </li>
                                <li><a href="#">List Products 1221 </a></li>
                                <li><a href="#">List Products 122</a></li>
                              </ul>
                            </div>
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Trending jobs</li>
                                <li><a href="#">List Products 13 </a> <span class="wstmenutag orangetag">20% off</span></li>
                                <li><a href="#">List Products 1222224</a></li>
                                <li><a href="#">List Products 122225</a></li>
                                <li><a href="#">List Products 12226</a> </li>
                                <li><a href="#">List Products 1227</a></li>
                                <li><a href="#">List Products 128</a></li>
                              </ul>
                            </div>
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">More Jobs</li>
                                <li><a href="#">List Products 19 </a> <span class="wstmenutag bluetag">Winter Offer</span></li>
                                <li><a href="#">List Products 220</a></li>
                                <li><a href="#">List Products 221</a></li>
                                <li><a href="#">List Products 222</a> </li>
                                <li><a href="#">List Products 223</a></li>
                                <li><a href="#">List Products 224</a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
                    ...
                    <li><a href="#"><i class="fa fa-slideshare brandcolor01" aria-hidden="true"></i> Architecture &amp; Interior Design</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Latest Jobs</li>
                                <li><a href="#">List Products 01 </a> <span class="wstmenutag redtag">Popular</span></li>
                                <li><a href="#">List Products 0ij2</a></li>
                                <li><a href="#">List Products 0ijij3</a></li>
                                <li><a href="#">List Products 0ij4</a> </li>
                                <li><a href="#">List Products 0ij5</a> </li>
                                <li><a href="#">List Products 0ij6</a></li>
                              </ul>
                            </div>
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Mostviewed Jobs</li>
                                <li><a href="#">List Products 0ij7 </a></li>
                                <li><a href="#">List Products 0ij8</a></li>
                                <li><a href="#">List Products 0ij9</a></li>
                                <li><a href="#">List Products 10</a> </li>
                                <li><a href="#">List Products 1ij1 </a></li>
                                <li><a href="#">List Products 1ij2</a></li>
                              </ul>
                            </div>
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Trending jobs</li>
                                <li><a href="#">List Products 13 </a> <span class="wstmenutag orangetag">20% off</span></li>
                                <li><a href="#">List Products 1ij4</a></li>
                                <li><a href="#">List Products 1ij5</a></li>
                                <li><a href="#">List Products 1ij6</a> </li>
                                <li><a href="#">List Products 1ij7</a></li>
                                <li><a href="#">List Products 1ij8</a></li>
                              </ul>
                            </div>
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">More Jobs</li>
                                <li><a href="#">List Products 19 </a> <span class="wstmenutag bluetag">Winter Offer</span></li>
                                <li><a href="#">List Products 2ij0</a></li>
                                <li><a href="#">List Products 2ij1</a></li>
                                <li><a href="#">List Products 22ij</a> </li>
                                <li><a href="#">List Products 2ij3</a></li>
                                <li><a href="#">List Products 2ij4</a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
                    ...
                    <li><a href="#"><i class="fa fa-slideshare brandcolor01" aria-hidden="true"></i>Banking &amp; Finance </a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                    ...
                    <li><a href="#"><i class="fa fa-slideshare brandcolor01"></i>Business Supplies &amp; Equipment</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                    ...
                    <li><a href="#"><i class="fa fa-slideshare brandcolor01"></i>Construction</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                    ...
                    <li><a href="#"><i class="fa fa-slideshare brandcolor01"></i>View All</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
            ...
            <li><a href="#" class="navtext"><span>Search in</span> <span>Tenders</span></a>
              <div class="wsshoptabing wtsbrandmenu clearfix">
                <div class="wsshoptabingwp clearfix">
                  <ul class="wstabitem02 clearfix">
                    <li class="wsshoplink-active"><a href="#"><i class="fa fa-university brandcolor01" aria-hidden="true"></i>Consultants</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Latest Tenders</li>
                                <li><a href="#">List Products 01 </a> <span class="wstmenutag redtag">Popular</span></li>
                                <li><a href="#">List Products 02</a></li>
                                <li><a href="#">List Products 03</a></li>
                                <li><a href="#">List Products 04</a> </li>
                            ...
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Mostviewed Tenders</li>
                                <li><a href="#">List Products 07 </a></li>
                                <li><a href="#">List Products 08</a></li>
                                <li><a href="#">List Products 09</a></li>
                                <li><a href="#">List Products 10</a> </li>
                            ...
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">More Tenders</li>
                                <li><a href="#">List Products 13 </a> <span class="wstmenutag orangetag">20% off</span></li>
                                <li><a href="#">List Products 14</a></li>
                                <li><a href="#">List Products 15</a></li>
                                <li><a href="#">List Products 16</a> </li>
                            ...
                            <div class="col-lg-3 col-md-12">
                              <div class="wstbootslider clearfix">
                                <div id="tenders" class="carousel slide" data-ride="carousel">

                                  <!-- The slideshow -->
                                  <div class="carousel-inner">
                                    <div class="carousel-item active"><img class="img-fluid" src="images/tender1.jpg" alt="" />
                                      <div class="carousel-caption">
                                        <h3>Slider Caption 01</h3>
                                      </div>
                                    </div>
                                    <div class="carousel-item"><img class="img-fluid" src="images/tender2.jpg" alt="" />
                                      <div class="carousel-caption">
                                        <h3>Slider Caption 01</h3>
                                      </div>
                                    </div>
                                    <div class="carousel-item"><img class="img-fluid" src="images/tender3.jpg" alt="" />
                                      <div class="carousel-caption">
                                        <h3>Slider Caption 01</h3>
                                      </div>
                                    </div>
                                  ...
                                  <!-- Left and right controls -->
                                  <a class="carousel-control-prev" href="#tenders" data-slide="prev"> <span class="carousel-control-prev-icon"></span> </a> <a class="carousel-control-next" href="#tenders" data-slide="next"> <span class="carousel-control-next-icon"></span> </a>                                  </div>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <li><a href="#"><i class="fa fa-university brandcolor01" aria-hidden="true"></i> Buildings</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Latest Tenders</li>
                                <li><a href="#">List Products 01 </a> <span class="wstmenutag redtag">Popular</span></li>
                                <li><a href="#">List Products 02 tenders</a></li>
                                <li><a href="#">List Products 03 tenders</a></li>
                                <li><a href="#">List Products 04</a> </li>
                                <li><a href="#">List Products 05 tenders</a> </li>
                                <li><a href="#">List Products 06 tenders</a></li>
                                <li><a href="#">List Products 14 tenders</a></li>
                                <li><a href="#">List Products 15 tenders</a></li>
                                <li><a href="#">List Products 16 tenders</a> </li>
                                <li><a href="#">List Products 17 tenders</a></li>
                                <li><a href="#">List Products 18 tenders</a></li>
                              </ul>
                            </div>
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Mostviewed Tenders</li>
                                <li><a href="#">List Products 07 tenders</a></li>
                                <li><a href="#">List Products 08 tenders</a></li>
                                <li><a href="#">List Products 09 tenders</a></li>
                                <li><a href="#">List Products 10 tenders</a> </li>
                                <li><a href="#">List Products 11 tenders</a></li>
                                <li><a href="#">List Products 12 tenders</a></li>
                                <li><a href="#">List Products 14 tenders</a></li>
                                <li><a href="#">List Products 15 tenders tenders</a></li>
                                <li><a href="#">List Products 16 tenders</a> </li>
                                <li><a href="#">List Products 17 tenders</a></li>
                                <li><a href="#">List Products 18 tenders</a></li>
                              </ul>
                    ...
                    <li><a href="#"><i class="fa fa-university brandcolor01" aria-hidden="true"></i> Roads &amp; Bridges</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Latest Tenders</li>
                                <li><a href="#">List Products 01 </a> <span class="wstmenutag redtag">Popular</span></li>
                                <li><a href="#">List Products 0221</a></li>
                                <li><a href="#">List Products 0321</a></li>
                                <li><a href="#">List Products 0421</a> </li>
                                <li><a href="#">List Products 0521</a> </li>
                                <li><a href="#">List Products 0621</a></li>
                                <li><a href="#">List Products 1421</a></li>
                                <li><a href="#">List Products 1521</a></li>
                                <li><a href="#">List Products 1621</a> </li>
                                <li><a href="#">List Products 1721</a></li>
                                <li><a href="#">List Products 1821</a></li>
                              </ul>
                            </div>
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Mostviewed Tenders</li>
                                <li><a href="#">List Products 0721 </a></li>
                                <li><a href="#">List Products 0821</a></li>
                                <li><a href="#">List Products 0921</a></li>
                                <li><a href="#">List Products 1021</a> </li>
                                <li><a href="#">List Products 11 21</a></li>
                                <li><a href="#">List Products 1221</a></li>
                                <li><a href="#">List Products 1421</a></li>
                                <li><a href="#">List Products 1521</a></li>
                                <li><a href="#">List Products 1621</a> </li>
                    ...
                    <li><a href="#"><i class="fa fa-university brandcolor01" aria-hidden="true"></i>Water &amp; Sewage</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                <li class="wstheading clearfix">Latest Tenders</li>
                                <li><a href="#">List Products 01 </a> <span class="wstmenutag redtag">Popular</span></li>
                                <li><a href="#">List Products 02re</a></li>
                                <li><a href="#">List Products 03re</a></li>
                                <li><a href="#">List Products 04re</a> </li>
                                <li><a href="#">List Products 05er</a> </li>
                                <li><a href="#">List Products 06er</a></li>
                                <li><a href="#">List Products 14er</a></li>
                                <li><a href="#">List Products 15er</a></li>
                                <li><a href="#">List Products 16er</a> </li>
                                <li><a href="#">List Products 17er</a></li>
                                <li><a href="#">List Products 18er</a></li>
                              </ul>
                            </div>
                            <div class="col-lg-3 col-md-12">
                              <ul class="wstliststy02 clearfix">
                                ...
                                <li><a href="#">List Products 07 </a></li>
                                <li><a href="#">List Products 08</a></li>
                                <li><a href="#">List Products 09er</a></li>
                                <li><a href="#">List Products 10er</a> </li>
                                <li><a href="#">List Products 11er </a></li>
                                <li><a href="#">List Products 12er</a></li>
                                <li><a href="#">List Products 14</a></li>
                                <li><a href="#">List Products 1er5</a></li>
                                <li><a href="#">List Products 16</a> </li>
                                <li><a href="#">List Products 17</a></li>
                                <li><a href="#">List Products 18</a></li>
                              </ul>
                    ...
                    <li><a href="#"><i class="fa fa-university brandcolor01"></i>Electromechanical</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                    ...
                    <li><a href="#"><i class="fa fa-university brandcolor01"></i>Industrial and Supplies</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                    ...
                    <li><a href="#"><i class="fa fa-university brandcolor01"></i>View All</a>
                      <div class="wsshoptab-active wstbrandbottom clearfix">
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
