...
<head>
  ...
  <link rel="stylesheet" href="css/personal.css?v=1.2" />
  						...
  						<div class="row" data-sticky_parent>
						    <div class="mid-content no-left">
							   <div class="rc-cmp-bx-tp-1 bc-none">
				  							...
				  							<div id="bx-tp-rc-gallery" class="owl-carousel owl-theme owl-box-tp-1">
											    <div class="item">
											    	<div class="col-tp-1-cnt text-center">
													   <div class="bx-tp-1-a pos-rel">
													   		<a href="#" class="bx-tp-1-a-lnk">
													   			<img src="images/demo5.jpeg" class="img-tp-12 bx-shdw-right">
													   			<div class="txt-tp-32">Anabella</div>
													        	<div class="txt-tp-c-1">Web UI/UX Developer</div>
													        	<span class="slider-btnmore-tp-8">follow</span>
													   		</a>
													   		<span class="icn-cl-1"><i class="fa fa-times" aria-hidden="true"></i></span>
													   </div>
													</div>
											    </div>
											    <div class="item">
											    	<div class="col-tp-1-cnt text-center">
													   <div class="bx-tp-1-a pos-rel">
													   		<a href="#" class="bx-tp-1-a-lnk">
													   			<img src="images/demo1.jpeg" class="img-tp-12 bx-shdw-right">
													   			<div class="txt-tp-32">Albert</div>
													        	<div class="txt-tp-c-1">Web UI/UX Developer</div>
													        	<span class="slider-btnmore-tp-8">follow</span>
													   		</a>
													   		<span class="icn-cl-1"><i class="fa fa-times" aria-hidden="true"></i></span>
											    ...
											    <div class="item">
											    	<div class="col-tp-1-cnt text-center">
													   <div class="bx-tp-1-a pos-rel">
													   		<a href="#" class="bx-tp-1-a-lnk">
													   			<img src="images/demo2.jpeg" class="img-tp-12 bx-shdw-right">
													   			<div class="txt-tp-32">Anabella</div>
													        	<div class="txt-tp-c-1">Web UI/UX Developer</div>
													        	<span class="slider-btnmore-tp-8">follow</span>
													   		</a>
											    ...
											    <div class="item">
											    	<div class="col-tp-1-cnt text-center">
													   <div class="bx-tp-1-a pos-rel">
													   		<a href="#" class="bx-tp-1-a-lnk">
													   			<img src="images/demo3.jpeg" class="img-tp-12 bx-shdw-right">
													   			<div class="txt-tp-32">Anabella</div>
													        	<div class="txt-tp-c-1">Web UI/UX Developer</div>
													        	<span class="slider-btnmore-tp-8">follow</span>
													   		</a>
											    ...
											    <div class="item">
											    	<div class="col-tp-1-cnt text-center">
													   <div class="bx-tp-1-a pos-rel">
													   		<a href="#" class="bx-tp-1-a-lnk">
													   			<img src="images/demo4.jpeg" class="img-tp-12 bx-shdw-right">
													   			<div class="txt-tp-32">Anabella</div>
													        	<div class="txt-tp-c-1">Web UI/UX Developer</div>
													        	<span class="slider-btnmore-tp-8">follow</span>
													   		</a>
											    ...
											    <div class="item">
											    	<div class="col-tp-1-cnt text-center">
													   <div class="bx-tp-1-a pos-rel">
													   		<a href="#" class="bx-tp-1-a-lnk">
													   			<img src="images/demo6.jpeg" class="img-tp-12 bx-shdw-right">
													   			<div class="txt-tp-32">Anabella</div>
													        	<div class="txt-tp-c-1">Web UI/UX Developer</div>
													        	<span class="slider-btnmore-tp-8">follow</span>
													   		</a>
					  			...
					  			<div class="bx-tp-personal-bx-1">
				  					<div class="lst-nav-tp-1">
										<nav class="navbar navbar-expand-lg">
										  ...
										  <div class="collapse navbar-collapse" id="navbarSupportedContent">
										    <ul class="navbar-nav mr-auto">
										      ...
										      <li class="nav-item">
										        <a class="nav-link" href="#">Home Town
										        	<span class="up-arrow">&nbsp;</span>
										        </a>
										      </li>
										    </ul>
				  					...
				  					<div class="bx-tp-lst-lct">
						  				<div class="row">
						  					<div class="col-md-4 grd-tp-3">
						  						<div class="grd-tp-5">
									  				<div class="rslt-box-1">
										  				<a href="#" class="rst-bx-bx-t-lnk-1">
										  					<table>
										  						<tr>
										  							<td class="align-middle wdt-100-px">
										  								<img class="lazy rst-bx-bx-t-lnk-1-img bx-shdw-right" data-src="images/demo1.jpeg" alt="Business Id" title="Business Id" >
										  							</td>
										  							<td class="align-middle pd-tp-25">
										  								<div class="txt-tp-32">Anabella</div>
										  								<div class="txt-tp-c-1">Web UI/UX Developer</div>
										  								<div class="bx-flw-flwng font-fmly-ar">
										  									<span class="spn-flw">11 following</span>
										  									<span class="spn-flwng">120 follow</span>
										  								</div>
										  								<span class="slider-btnmore-tp-8">follow</span>
										  							</td>
										  						</tr>
									  				...
									  				<div class="rslt-box-1">
										  				<a href="#" class="rst-bx-bx-t-lnk-1">
										  					<table>
										  						<tr>
										  							<td class="align-middle wdt-100-px">
										  								<img class="lazy rst-bx-bx-t-lnk-1-img bx-shdw-right" data-src="images/demo2.jpeg" alt="Business Id" title="Business Id" >
										  							</td>
										  							<td class="align-middle pd-tp-25">
										  								<div class="txt-tp-32">Amigo John</div>
										  								<div class="txt-tp-c-1">Assistant Manager</div>
										  								<div class="bx-flw-flwng font-fmly-ar">
										  									<span class="spn-flw">11 following</span>
										  									<span class="spn-flwng">120 follow</span>
										  								</div>
									  				...
									  				<div class="rslt-box-1">
										  				<a href="#" class="rst-bx-bx-t-lnk-1">
										  					<table>
										  						<tr>
										  							<td class="align-middle wdt-100-px">
										  								<img class="lazy rst-bx-bx-t-lnk-1-img bx-shdw-right" data-src="images/demo3.jpeg" alt="Business Id" title="Business Id" >
										  							</td>
										  							<td class="align-middle pd-tp-25">
										  								<div class="txt-tp-32">jabbbz Jasmin</div>
										  								<div class="txt-tp-c-1">Assistant Manager</div>
										  								<div class="bx-flw-flwng font-fmly-ar">
										  									<span class="spn-flw">11 following</span>
										  									<span class="spn-flwng">120 follow</span>
										  				...
										  				<a href="#" class="rst-bx-bx-t-lnk-1">
										  					<table>
										  						<tr>
										  							...
										  							<td class="align-middle pd-tp-25">
										  								<div class="txt-tp-32">Harish Kanaran</div>
										  								<div class="txt-tp-c-1">Web UI/UX Developer</div>
										  								<div class="bx-flw-flwng font-fmly-ar">
										  									<span class="spn-flw">11 following</span>
										  									<span class="spn-flwng">120 follow</span>
									  				...
									  				<div class="rslt-box-1">
										  				<a href="#" class="rst-bx-bx-t-lnk-1">
										  					<table>
										  						<tr>
										  							<td class="align-middle wdt-100-px">
										  								<img class="lazy rst-bx-bx-t-lnk-1-img bx-shdw-right" data-src="images/demo4.jpeg" alt="Business Id" title="Business Id" >
										  							</td>
										  							<td class="align-middle pd-tp-25">
										  								<div class="txt-tp-32">Father Dizuza</div>
										  								<div class="txt-tp-c-1">Assistant Manager</div>
										  								<div class="bx-flw-flwng font-fmly-ar">
										  									<span class="spn-flw">11 following</span>
										  									<span class="spn-flwng">120 follow</span>
									  				...
									  				<div class="rslt-box-1">
										  				<a href="#" class="rst-bx-bx-t-lnk-1">
										  					<table>
										  						<tr>
										  							<td class="align-middle wdt-100-px">
										  								<img class="lazy rst-bx-bx-t-lnk-1-img bx-shdw-right" data-src="images/demo5.jpeg" alt="Business Id" title="Business Id" >
										  							</td>
										  							<td class="align-middle pd-tp-25">
										  								<div class="txt-tp-32">Camel Cat</div>
										  								<div class="txt-tp-c-1">Assistant Manager</div>
										  								<div class="bx-flw-flwng font-fmly-ar">
										  									<span class="spn-flw">11 following</span>
										  									<span class="spn-flwng">120 follow</span>
