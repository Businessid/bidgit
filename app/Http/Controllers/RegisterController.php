...
class RegisterController extends BaseController
{
        ...
        public function insert_personal(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'email' => 'required|email|confirmed|unique:tbl_users,email',
        ...
        $user_data['birthday'] = $request->input('birthday');
    ...
    public function company(Request $request)
    {
        ...
        return view('front_end.company_register', compact('categories', 'countries', 'company_info', 'company_user_info'), $data);
    ...
    public function licence(Request $request)
    {
        ...
        $company_info = $request->session()->get('company_info');
        if ($complete_step < 1) {
            return Redirect::to('register/company')->withInput();
        } else {
            $legalstatus = Users_Legal_Status::where('title_en', '<>', '')->orderBy('title_en')->get();
            $data['step'] = 2;
            $data['complete_step'] = $complete_step;
            return view('front_end.company_register', compact('legalstatus', 'company_info', 'licence_info'), $data);
        }
    }
    ...
    public function location(Request $request)
    {
        ...
        if ($complete_step < 2) {
            ...
            $data['step'] = 3;
            $data['complete_step'] = $complete_step;
            return view('front_end.company_register', compact('countries', 'company_info', 'location_info'), $data);
        }
    ...
    public function insert_qregister(Request $request)
    {
        ...
        $licence_info = $request->session()->get('licence_info');
        $location_info = $request->session()->get('location_info');
        $company_info = array_merge($company_info, $licence_info, $location_info);
        ...
        if ($result) {
            ...
            if ($result) {
                ...
                Companies::where("pk_companies_id", $Company_Last_ID)->delete();
            }
    ...
    public function sendEmail($to, $Temp){
        $subject = "Confirm Registration In Business ID";
    ...
    public function ConfirmEmailTmplate($first_name, $last_name, $code)
    {
        $Email_Templet = "
<head>
        ...
        <td class=\"center\" align=\"center\" valign=\"top\" style=\"-moz-hyphens: auto; -webkit-hyphens: auto; border-collapse: collapse !important; color: #1C232B; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; hyphens: auto; line-height: 1.3; margin: 0; padding: 0; text-align: left; vertical-align: top; word-wrap: break-word\">
          <center style=\"min-width: 580px; width: 100%\">
            ...
            <div class=\"milkyway-header float-center\" align=\"center\">
             <img src=\"data:image/png;base64,\"   style=\"-ms-interpolation-mode: bicubic; clear: both; display: block; max-width: 100%; outline: none; text-decoration: none; width: auto\">
            </div>
                                                ...
                                                <tr style=\"padding: 0; text-align: left; vertical-align: top\" align=\"left\">
                                                  <td style=\"-moz-hyphens: auto; -webkit-hyphens: auto; border-collapse: collapse !important; color: #1C232B; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; hyphens: auto; line-height: 1.3; margin: 0; padding: 0; text-align: left; vertical-align: top; word-wrap: break-word\"
                                                    ...
                                                    <table style=\"border-collapse: collapse; border-spacing: 0; padding: 0; text-align: left; vertical-align: top; width: 100%\">
                                                      <tbody>
                                                        <tr style=\"padding: 0; text-align: left; vertical-align: top\" align=\"left\">
                                                          <td style=\"-moz-hyphens: auto; -webkit-hyphens: auto; background: #d11d2f; border: 2px none #d11d2f; border-collapse: collapse !important; border-radius: 6px; color: #FFFFFF; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; hyphens: auto; line-height: 1.3; margin: 0; padding: 0; text-align: left; vertical-align: top; word-wrap: break-word\"
                                                            align=\"left\" bgcolor=\"#d11d2f\" valign=\"top\">
                                                            <a href=\"#\" style=\"border: 0 solid #d11d2f; border-radius: 6px; color: #FFFFFF; display: inline-block; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 1.3; margin: 0; padding: 13px 0; text-align: center; text-decoration: none; width: 100%\"
                                                              target=\"_blank\">
